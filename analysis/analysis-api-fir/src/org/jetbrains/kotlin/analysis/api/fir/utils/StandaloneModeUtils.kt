...
import org.jetbrains.kotlin.analysis.project.structure.impl.StaticProjectStructureProvider
 ...
 */
fun configureApplicationEnvironment(app: MockApplication) {
...
fun configureProjectEnvironment(
    ...
    project.picoContainer.registerComponentInstance(
        ...
        StaticProjectStructureProvider(compilerConfig, project, ktFiles)
    )
    project.picoContainer.registerComponentInstance(
